...
# Create HyperFlex Infra Network: Storage Data Network 

resource "dcnm_rest" "HXV-CL1-StorageData_NET_Create" {
  path    = "/rest/top-down/fabrics/MSD_Fabric_East/networks"
  payload = <<EOF
  { 
      "fabric": "MSD_Fabric_East", 
      "vrf": "NA",
      "networkName": "${var.hxv_vxlan_StorageData_NET.networkName}",
      "displayName": "${var.hxv_vxlan_StorageData_NET.networkName}",
      "networkId": "22002",
      "networkTemplateConfig": "{\"gatewayIpAddress\":\"\",\"gatewayIpV6Address\":\"\",\"vlanName\":\"\",\"intfDescription\":\"\",\"mtu\":\"\",\"secondaryGW1\":\"\",\"secondaryGW2\":\"\",\"secondaryGW3\":\"\",\"secondaryGW4\":\"\",\"suppressArp\":false,\"rtBothAuto\":false,\"tag\":\"12345\",\"vrfName\":\"NA\",\"isLayer2Only\":${var.hxv_vxlan_StorageData_NET.isLayer2Only},\"nveId\":1,\"vlanId\":${var.hxv_vxlan_StorageData_NET.vlanId},\"segmentId\":\"22002\",\"networkName\":\"HXV-CL1-StorageData_NET\"}",
...
# Attach HyperFlex Infra Network: (Storage Data Network) to Site-A and Site-B switches

resource "dcnm_rest" "HXV-CL1-StorageData_NET_Attach" {
